...
# Title: Victor's FM Receiver
# Author: Victor Ansart
# Description: FM Receiver for 22Mhz to 1.1Ghz
# Generated: Tue Dec 17 19:53:00 2013
##################################################
...
class Victor_FM_Receiver(grc_wxgui.top_block_gui):
	...
	def set_freq_fine(self, freq_fine):
		...
		self.set_freq(96900000+self.freq_fine)
